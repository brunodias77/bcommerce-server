...
public class Client : AggregateRoot
{
    ...
    private Client() : base() { }
        ...
        public static Client With(
            ...
            bool newsletterOptIn, ClientStatus status, DateTime createdAt,
        ...
        public void AddAddress(Address address, IValidationHandler handler)
        {
            ...
            {
                // Garante que apenas um endereço de cada tipo seja o padrão
        ...
        {
            // Regra: o primeiro cartão adicionado se torna o padrão.
        ...
        public void SetDefaultCard(Guid cardId)
        {
            ...
            // Remove o status de padrão do cartão antigo
