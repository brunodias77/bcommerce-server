...
namespace Bcommerce.UnitTest.Domain.Entities.Coupons
{
    ...
    public class CouponUnitTest
    {
        ...
        //         code: _fixture.GetValidCode(),
        //         percentage: 15,
        //         validFrom: DateTime.UtcNow,
        //         validUntil: DateTime.UtcNow.AddDays(5),
        //         handler: handler,
        //         minPurchase: Money.Create(10) // Parâmetro nomeado corretamente
        //     );
        //
        //     handler.HasError().Should().BeFalse(); // Agora passa
        ...
        public void NewCoupon_WithInvalidData_ShouldReturnError(string code, decimal percentage, string expectedError)
        {
            ...
            // Verificamos se a mensagem de erro esperada está contida nos erros retornados
            handler.GetErrors().Should().Contain(e => e.Message == expectedError);
        }
